package com.example.root.tugasloginconstrain;
...
public class MainActivity extends AppCompatActivity {
    ...
    public final static String EXTRA_MESSAGE = "com.example.root.MESSAGE";
    ...
    public void goLogin(View view) {
        Intent main = new Intent(this, com.example.root.tugasloginconstrain.SecondActivity.class);
